...
<h2 class="text-center text-3xl font-bold bg-gray-50  text-black pt-24 pb-4">All Books!</h2>
<main class="flex flex-col-reverse md:flex-row-reverse pt-4 pb-4 bg-gray-50">
